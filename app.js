...
// connect to the database as development or production. For production change to DB_URL
...
const sessionConfig = {
  ...
  cookie: {
    httpOnly: true,
    // localhost is not secure, so we set secure to false
    // secure: true,
...
app.use(
  helmet.contentSecurityPolicy({
    directives: {
      ...
      workerSrc: ["'self'", 'blob:'],
      objectSrc: [],
      imgSrc: ["'self'", 'blob:', 'data:', 'https://res.cloudinary.com/dvakrjz9o/', 'https://images.unsplash.com/'],
